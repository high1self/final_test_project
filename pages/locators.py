...
class ProductPageLocators():
    ...
    PRODUCT_NAME_IN_BASKET = (By.CSS_SELECTOR, "#messages>:nth-child(1) .alertinner>strong")
    PRODUCT_NAME = (By.CSS_SELECTOR, ".col-sm-6.product_main>h1")
    BASKET_PRICE = (By.CSS_SELECTOR, ".alert.alert-safe.alert-noicon.alert-info.fade.in>.alertinner>p>strong")
    PRODUCT_PRICE = (By.CSS_SELECTOR, ".col-sm-6.product_main>.price_color")
    SUCCESS_MESSAGE = (By.CSS_SELECTOR, "#messages>:nth-child(1) .alertinner>strong")

# локаторы которые видно с любых страниц
class BasePageLocators():
    LOGIN_LINK = (By.CSS_SELECTOR, "#login_link")
    LOGIN_LINK_INVALID = (By.CSS_SELECTOR, "#login_link_inc")
    BASKET_OPEN = (By.CSS_SELECTOR, ".btn-group .btn.btn-default:nth-child(1)")
